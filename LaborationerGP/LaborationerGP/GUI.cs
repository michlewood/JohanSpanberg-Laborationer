...
class GUI
{
    ...
    public static void MainMenuGUI()
    {
        ...
        WriteColorString("Choose from the menu", 12, 20, ConsoleColor.Black, ConsoleColor.White);
        ...
        WriteColorString("You chose " + mainMenuChoice[choice - 1] + ". Press any key to exit", 21, 22, ConsoleColor.Black, ConsoleColor.White);
        Console.ReadKey();
